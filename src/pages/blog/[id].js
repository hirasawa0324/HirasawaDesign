...
export const getStaticPaths = async () => {
    const data = await client.get({ endpoint: "blogs" }); // "blog" から "blogs" へ修正
  ...
  export const getStaticProps = async (context) => {
    ...
    const data = await client.get({ endpoint: "blogs", contentId: id }); // "blog" から "blogs" へ修正
